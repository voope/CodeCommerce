        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                <div class="productinfo text-center">
                    ...
                    <p>{{ $product->name }}</p>
                    <a href="{{ route('product') }}" class="btn btn-default add-to-cart"><i class="fa fa-crosshairs"></i>Mais detalhes</a>
                ...
                <div class="product-overlay">
                    <div class="overlay-content">
                        <h2>R$ {{ $product->price }}</h2>
                        <p>{{ $product->name }}</p>
                        <a href="{{ route('product', $product) }}" class="btn btn-default add-to-cart"><i class="fa fa-crosshairs"></i>Mais detalhes</a>
